...
if [ ! -f archives/spark-2.3.3-bin-hadoop2.7.tgz ]; then
  cd archives
  wget http://apache.cs.utah.edu/spark/spark-2.3.3/spark-2.3.3-bin-hadoop2.7.tgz
  cd ~-
fi && \
tar -xvf archives/spark-2.3.3-bin-hadoop2.7.tgz && \
