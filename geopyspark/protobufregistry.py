...
from geopyspark.protobuf.tilemessages import *
from geopyspark.protobuf.extentmessages import *
from geopyspark.protobuf.keymessages import *
from geopyspark.protobuf.tuplemessages import *
...
class ProtoBufRegistry(object):
    ...
    @classmethod
    def extent_decoder(array_bytes):
        return ProtoExtent().create_from_bytes(array_bytes)

    @classmethod
    def crs_decoder(array_bytes):
        return ProtoCRS().create_from_bytes(array_bytes)
