from protobuf3.fields import MessageField, StringField, Int32Field, DoubleField, UInt64Field
...
TemporalProjectedExtent.add_field('instant', UInt64Field(field_number=3, optional=True))
